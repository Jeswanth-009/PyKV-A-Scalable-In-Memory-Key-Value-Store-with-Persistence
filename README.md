...
- [client.py](client.py)
  - Command-line client using requests
  - Supports GET, POST, and DELETE against `/keys/{key}`

- [perf_compare.py](perf_compare.py)
  - CLI benchmark runner for performance reporting
  - Compares local dict speed vs HTTP store speed
